...
2. Использование только в качестве определения нарушения и/или выявления людей в кадре.

Здесь используется тот же запрос, что и в предыдущем пункте. В ответ придет результат анализа.
